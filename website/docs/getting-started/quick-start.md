...
:::note
This guide uses the class-and-decorator style, which is what we recommend. If you prefer plain functions with no decorators, Outpost supports that too, and it behaves identically. See [The functional style](../concepts/functional-style.md).
:::
...
- Prefer plain functions over classes? See [The functional style](../concepts/functional-style.md).
