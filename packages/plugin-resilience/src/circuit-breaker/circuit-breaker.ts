...
export class CircuitBreaker {
    ...
    /**
     * Returns the breaker's current state, accounting for an elapsed reset
     * timeout.
     */
     ...
     * {@link CircuitOpenError} is thrown instead. Otherwise the operation runs
     * and its success or failure updates the breaker's state.
     */
    ...
    /**
     * Records a successful call, closing the breaker and clearing the failure
     * count.
     */
    ...
    /**
     * Records a failed call, tripping the breaker open when the threshold is
     * met.
     */
