...
export default async function Home() {
    ...
    return (
        <Box>
            ...
            >
                <Container maxWidth="lg" sx={{ pt: { xs: 8, md: 14 }, pb: { xs: 8, md: 12 } }}>
                    <Stack spacing={4} alignItems="center" textAlign="center">
                        ...
                        <Typography
                            variant="h1"
                            sx={{ fontSize: { xs: 40, md: 68 }, maxWidth: 900 }}
                        >
                ...
                <Grid container spacing={6} alignItems="center">
                    <Grid size={{ xs: 12, md: 5 }}>
                        ...
                        <Typography sx={{ color: "text.secondary" }}>
                            ...
                            and <strong>probes before it re-executes</strong>.
                        </Typography>
                    </Grid>
            ...
            <Box id="why" sx={{ bgcolor: "background.paper", py: { xs: 8, md: 12 } }}>
                        ...
                        <Stack spacing={2}>
                            {limits.map((limit, i) => (
                                <Box key={i}>
                                    ...
                                    {i < limits.length - 1 && (
                                        <Divider
                                            sx={{ mt: 2, borderColor: "rgba(255,255,255,0.06)" }}
                                        />
                                    )}
                                </Box>
                            ))}
